...
impl Texture {
    pub fn create_texture_data(device: &wgpu::Device, queue: &wgpu::Queue, img_file: &str, u_mode:wgpu::AddressMode, v_mode:wgpu::AddressMode,) -> Result<Self> {
    ...
    let view= texture.create_view(&wgpu::TextureViewDescriptor::default()); let sampler = device.create_sampler (
